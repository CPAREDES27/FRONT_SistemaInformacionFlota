		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca Competencia-Radial Reporte",
									"targetURL": "#PescaCompetenciaRadialReporte-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaCompetenciaRadialReporte-display": {
								"semanticObject": "PescaCompetenciaRadialReporte",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pcptradreporte",
									"url": sap.ui.require.toUrl("com/tasa/pcptradreporte")
								}
							}
						}
					}
