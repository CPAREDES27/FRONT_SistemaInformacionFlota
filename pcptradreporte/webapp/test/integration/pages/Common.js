sap.ui.define([
	...
	return Opa5.extend("com.tasa.pcptradreporte.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/tasa/pcptradreporte/localService/mockserver"], function (mockserver) {
