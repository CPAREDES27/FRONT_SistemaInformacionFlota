		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca Declarada Diaria",
									"targetURL": "#PescaDeclaradaDiaria-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaDeclaradaDiaria-display": {
								"semanticObject": "PescaDeclaradaDiaria",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pdeclaradadiaria",
									"url": sap.ui.require.toUrl("com/tasa/pdeclaradadiaria")
								}
							}
						}
					}
