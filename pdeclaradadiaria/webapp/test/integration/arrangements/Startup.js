sap.ui.define([
	"sap/ui/test/Opa5",
	"com/tasa/pdeclaradadiaria/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.tasa.pdeclaradadiaria.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.tasa.pdeclaradadiaria",
					async: true
				},
				hash: oOptions.hash,
