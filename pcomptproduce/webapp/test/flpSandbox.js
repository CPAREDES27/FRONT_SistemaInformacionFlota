		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca de competencia - PRODUCE ",
									"targetURL": "#PescadecompetenciaPRODUCE-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescadecompetenciaPRODUCE-display": {
								"semanticObject": "PescadecompetenciaPRODUCE",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pcomptproduce",
									"url": sap.ui.require.toUrl("com/tasa/pcomptproduce")
								}
							}
						}
					}
