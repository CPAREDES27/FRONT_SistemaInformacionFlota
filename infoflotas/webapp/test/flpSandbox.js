		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sistema de inforación de flotas",
									"targetURL": "#Sistemadeinforacióndeflotas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Sistemadeinforacióndeflotas-display": {
								"semanticObject": "Sistemadeinforacióndeflotas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.infoflotas",
									"url": sap.ui.require.toUrl("com/tasa/infoflotas")
								}
							}
						}
					}
