		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca Descargada",
									"targetURL": "#PescaDescargada-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaDescargada-display": {
								"semanticObject": "PescaDescargada",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pdescargada",
									"url": sap.ui.require.toUrl("com/tasa/pdescargada")
								}
							}
						}
					}
