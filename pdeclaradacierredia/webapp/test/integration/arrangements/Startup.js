sap.ui.define([
	"sap/ui/test/Opa5",
	"com/tasa/pdeclaradacierredia/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.tasa.pdeclaradacierredia.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.tasa.pdeclaradacierredia",
					async: true
				},
				hash: oOptions.hash,
