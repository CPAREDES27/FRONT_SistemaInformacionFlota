		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca declarada al cierre del día",
									"targetURL": "#Pescadeclaradaalcierredeldía-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Pescadeclaradaalcierredeldía-display": {
								"semanticObject": "Pescadeclaradaalcierredeldía",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pdeclaradacierredia",
									"url": sap.ui.require.toUrl("com/tasa/pdeclaradacierredia")
								}
							}
						}
					}
