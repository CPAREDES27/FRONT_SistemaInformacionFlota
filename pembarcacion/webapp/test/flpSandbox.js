		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca por Embarcación",
									"targetURL": "#PescaporEmbarcación-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaporEmbarcación-display": {
								"semanticObject": "PescaporEmbarcación",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pembarcacion",
									"url": sap.ui.require.toUrl("com/tasa/pembarcacion")
								}
							}
						}
					}
