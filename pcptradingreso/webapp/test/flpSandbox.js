		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca Competencia Radial-Ingreso",
									"targetURL": "#PescaCompetenciaRadialIngreso-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaCompetenciaRadialIngreso-display": {
								"semanticObject": "PescaCompetenciaRadialIngreso",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pcptradingreso",
									"url": sap.ui.require.toUrl("com/tasa/pcptradingreso")
								}
							}
						}
					}
