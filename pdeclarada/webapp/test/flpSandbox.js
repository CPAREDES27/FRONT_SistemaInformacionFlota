		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesca Declarada",
									"targetURL": "#PescaDeclarada-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PescaDeclarada-display": {
								"semanticObject": "PescaDeclarada",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.pdeclarada",
									"url": sap.ui.require.toUrl("com/tasa/pdeclarada")
								}
							}
						}
					}
