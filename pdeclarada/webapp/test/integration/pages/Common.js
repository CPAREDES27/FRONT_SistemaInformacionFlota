sap.ui.define([
	...
	return Opa5.extend("com.tasa.pdeclarada.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/tasa/pdeclarada/localService/mockserver"], function (mockserver) {
