		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Compra cuota terceros",
									"targetURL": "#Compracuotaterceros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Compracuotaterceros-display": {
								"semanticObject": "Compracuotaterceros",
								"action": "display",
								"description": "App de Sist. Inf. Flota",
								"title": "Compra cuota terceros",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.compracuotaterc",
									"url": sap.ui.require.toUrl("com/tasa/compracuotaterc")
								}
							}
						}
					}
